...
# ========= 基础 =========
rarity_list = ["普通","非普通","珍稀","极珍稀","传说","神器","多种稀有度","独特"]
...
术士 法师 魔契师 奇械师 拳斗士
野蛮人 武僧 战士 游荡者 施法者 
武器选择的生物 与矮人腰带维持同调的生物 斧认定有价值的生物
半精灵 妖精 小型类人 精灵 矮人
中立阵营的生物 善良阵营的施法者 善良阵营的生物
感知13+的生物 敏捷17+的生物 智力17+的生物 力量15+的生物
缺失眼 缺失手 缺失腿 缺失臂
...
class MagicItem:
    def __init__(self, content, chm_path="", source="未知"):
        ...
        # ========= 稀有度 =========
        rarities = re.findall(
            r"(多种稀有度|非普通|极珍稀|珍稀|传说|神器|普通|独特)",
            subline
        )
